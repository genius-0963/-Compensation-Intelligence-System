...
export function VerificationUploadStep({ form }: { form: any }) {
  return (
    <div className="space-y-6">
       <div>
         <h2 className="text-2xl font-black text-gray-900 mb-2">Offer Verification</h2>
         <p className="text-sm text-gray-500 font-medium">Upload your offer letter, W2, or payslip to verify your submission.</p>
       </div>

       <div className="border-2 border-dashed border-gray-200 rounded-3xl p-10 flex flex-col items-center justify-center text-center hover:border-blue-300 transition-all">
          <UploadCloud className="h-12 w-12 text-gray-300 mb-4" />
          <h3 className="font-bold text-gray-900 mb-2">Drag & Drop files</h3>
